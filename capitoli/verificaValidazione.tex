...
\begin{itemize}
	...
	\item incoerenza tra \glossaryItem{parametri formali} e \glossaryItem{attuali} nelle chiamate a metodi e/o funzioni.
\end{itemize}
...
Per il test del funzionamento dell'applicazione si è utilizzato l'\glossaryItem{emulatore} dell'\textit{IDE} \textit{Android Studio}. È stato testato il funzionamento di:
\begin{itemize}
