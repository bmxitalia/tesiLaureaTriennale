...
Per il test dell'applicazione, e quindi dell'usabilità e del funzionamento dell'interfaccia grafica, si è utilizzato l'emulatore dell'IDE Android Studio. Per il test della logica dell'applicazione si è considerato:
\begin{itemize}
...
Per il test del layout responsive dell'applicazione si sono utilizzati gli strumenti per gli sviluppatori del browser Google Chrome. In particolare si è testato il comportamento del layout su tutte le fasce di dispositivi, ovvero su schermi piccoli, medi e grandi (\glossaryItem{phablet}).
