...
\endhead
RFO1 & Se l'applicazione viene lanciata in assenza di connettività, deve essere visualizzato un messaggio d'errore di connettività assente e l'applicazione deve essere chiusa & - \\ \hline
...
RFO2.7 & Se il server non risponde in fase di login, deve essere visualizzato un messaggio d'errore che notifichi che il server è down & - \\ \hline
RFO3 & Se l'utente non autenticato riesce ad accedere, deve essere visualizzata la home page dell'applicazione & Capitolato \\ \hline
RFO3.1 & L'utente autenticato deve visualizzare la propria ragione sociale nella home page & Capitolato \\ \hline
RFO3.2 & L'utente autenticato deve poter visualizzare il tutorial dell'applicazione nella home page & UC2.2 \\ \hline
RFO3.3 & L'utente autenticato deve poter effettuare il logout dall'applicazione premendo su un bottone & UC2.1 \\ \hline
RFO3.4 & L'utente autenticato deve poter visualizzare i propri articoli nel carrello sulla home page & Capitolato \\ \hline
RFO3.4.1 & Se l'utente autenticato non presenta articoli in carrello, deve essere visualizzata una frase che notifichi che il carrello è vuoto & - \\ \hline
...
RFO3.5 & L'utente autenticato deve poter aggiungere un nuovo articolo al carrello dalla home page & Capitolato UC2.3.1 \\ \hline
RFO3.5.1 & Per aggiungere un nuovo articolo al carrello, l'utente autenticato deve inserire un codice articolo & UC \\ \hline
RFO3.5.2 & L'utente autenticato deve poter decidere se inserire il codice articolo con la scansione di un codice a barre o manualmente & UC \\ \hline
RFO3.5.3 & Se l'utente autenticato decide di inserire il codice articolo con la scansione di un codice a barre, l'applicazione deve accedere alla fotocamera e permettere la cattura del codice a barre & UC \\ \hline
RFO3.5.3.1 & L'applicazione deve permettere la cattura del codice a barre di tipo EAN13 & UC \\ \hline
RFO3.5.3.2 & L'applicazione deve permettere la cattura del codice a barre di tipo EAN8 & UC \\ \hline
RFO3.5.3.3 & L'applicazione deve permettere la cattura del codice a barre di tipo CODE39 & UC \\ \hline
RFO3.5.3.4 & L'applicazione deve permettere la cattura del codice a barre di tipo UPC & UC \\ \hline
RFO3.5.3.5 & L'applicazione deve permettere la cattura del codice a barre di tipo QR & UC \\ \hline
RFO3.5.3.6 & L'utente autenticato deve poter annullare la scansione del codice a barre con il tasto indietro & UC \\ \hline
RFO3.5.3.7 & Se l'utente autenticato annulla la scansione del codice a barre deve essere visualizzato un messaggio di annullamento della scansione da parte dell'utente & UC \\ \hline
RFO3.5.3.8 & Se la scansione del codice a barre fallisce, la fotocamera deve essere chiusa e deve essere visualizzato un messaggio d'errore di scansione fallita & UC \\ \hline
RFO3.5.3.9 & Se la scansione del codice a barre va a buon fine ma il codice ottenuto non corrisponde ad un articolo venduto dall'azienda deve essere visualizzato un messaggio d'errore che notifichi il problema & UC \\ \hline
RFO3.5.3.10 & Se la scansione del codice a barre va a buon fine e il codice ottenuto corrisponde ad un articolo venduto dall'azienda ma l'articolo è già presente in carrello, deve essere visualizzato un messaggio che inviti l'utente a cambiare la quantità dell'articolo in carrello & UC \\ \hline
RFO3.5.3.11 & Se la scansione del codice a barre va a buon fine e il codice ottenuto corrisponde ad un articolo venduto dall'azienda deve essere visualizzata la pagina di aggiunta articolo & UC \\ \hline
RFO3.5.4 & Se l'utente autenticato decide di inserire il codice articolo manualmente deve essere visualizzata una text box per l'inserimento del codice & UC \\ \hline
RFO3.5.4.1 & Se l'utente autenticato inserisce un codice articolo che non corrisponde ad un articolo venduto dall'azienda, deve essere visualizzato un messaggio d'errore che notifichi il problema & UC \\ \hline
RFO3.5.4.2 & Se l'utente autenticato inserisce un codice articolo che corrisponde ad un articolo venduto dall'azienda ma l'articolo è già presente in carrello, deve essere visualizzato un messaggio che inviti l'utente a cambiare la quantità dell'articolo in carrello & UC \\ \hline
RFO3.5.4.3 & Se l'utente autenticato inserisce un codice articolo che corrisponde ad un articolo venduto dall'azienda, deve essere visualizzata la pagina di aggiunta articolo & UC \\ \hline
RFO3.5.5 & L'utente autenticato deve poter visualizzare il codice articolo nella pagina di aggiunta articolo & UC \\ \hline
RFO3.5.6 & L'utente autenticato deve poter visualizzare la descrizione dell'articolo nella pagina di aggiunta articolo & UC \\ \hline
RFO3.5.7 & L'utente autenticato deve poter visualizzare le informazioni dell'articolo nella pagina di aggiunta articolo & UC \\ \hline
RFO3.5.8 & La pagina di aggiunta articolo deve proporre all'utente autenticato una quantità minima per l'articolo da ordinare & UC \\ \hline
RFO3.5.9 & L'utente autenticato deve poter inserire una quantità per l'articolo da ordinare nella pagina di aggiunta articolo & UC \\ \hline
RFO3.5.10 & L'utente autenticato deve poter inserire delle note per l'articolo da ordine nella pagina di aggiunta articolo & \\ \hline
RFO3.5.11 & L'utente autenticato deve poter annullare l'inserimento dell'articolo nella pagina di aggiunta articolo & \\ \hline
RFO3.5.12 & L'utente autenticato deve poter confermare l'inserimento dell'articolo nella pagina di aggiunta articolo & \\ \hline
RFO3.5.13 & Se l'utente autenticato conferma l'inserimento dell'articolo ed ha inserito una quantità errata (troppo bassa, troppo alta o che non soddisfa uno step impostato dall'azienda) deve essere visualizzato un messaggio d'errore di errata quantità inserita & \\ \hline
RFO3.5.14 & Se l'utente autenticato conferma l'inserimento dell'articolo e i dati inseriti sono corretti, deve essere visualizzata la home page e il nuovo articolo deve essere presente in carrello & \\ \hline
RFO3.5.15 & Se l'utente autenticato annulla l'inserimento dell'articolo, deve essere visualizzata la home page e il carrello non deve essere cambiato & \\ \hline
RFO3.5.16 & Se viene persa la connettività nella pagina di aggiunta articolo, deve essere visualizzato un messaggio che invita l'utente a chiudere l'applicazione per connettività assente & \\ \hline
RFO3.6 & L'utente autenticato deve poter selezionare un articolo in carrello premendo sulla relativa check-box & \\ \hline
RFO3.7 & L'utente autenticato deve poter deselezionare un articolo in carrello selezionato premendo sulla relativa check-box & \\ \hline
RFO3.8 & L'utente autenticato deve poter selezionare tutti gli articoli in carrello premendo su un bottone di seleziona tutti/deseleziona tutti presente nella home page & \\ \hline
RFO3.9 & L'utente autenticato deve poter deselezionare tutti gli articoli in carrello premendo su un bottone di seleziona tutti/deseleziona tutti presente nella home page & \\ \hline
RFO3.10 & L'utente autenticato deve poter modificare un articolo in carrello premendo sopra l'articolo direttamente sul carrello & \\ \hline
RFO3.10.1 & Se l'utente autenticato preme su un articolo in carrello deve essere visualizzato un dialog che chiede all'utente se vuole modificare l'articolo & \\ \hline
RFO3.10.2 & Se l'utente autenticato accetta di modificare l'articolo sul dialog di conferma, deve essere aperta la pagina di modifica articolo & \\ \hline
RFO3.10.3 & Se l'utente autenticato rifiuta di modificare l'articolo sul dialog di conferma, deve essere visualizzata la home page senza cambiamenti sul carrello & \\ \hline
RFO3.10.4 & L'utente autenticato deve poter visualizzare il codice articolo dell'articolo selezionato nella pagina di modifica articolo & UC \\ \hline
RFO3.10.5 & L'utente autenticato deve poter visualizzare la descrizione dell'articolo dell'articolo selezionato nella pagina di modifica articolo & UC \\ \hline
RFO3.10.6 & L'utente autenticato deve poter visualizzare le informazioni dell'articolo dell'articolo selezionato nella pagina di modifica articolo & UC \\ \hline
RFO3.10.7 & La pagina di modifica articolo deve proporre all'utente autenticato la quantità precedentemente inserita per l'articolo selezionato & UC \\ \hline
RFO3.10.8 & L'utente autenticato deve poter cambiare la quantità per l'articolo selezionato nella pagina di modifica articolo & UC \\ \hline
RFO3.10.9 & La pagina di modifica articolo deve proporre all'utente autenticato le note precedentemente inserite per l'articolo selezionato & UC \\ \hline
RFO3.10.10 & L'utente autenticato deve poter modificare le note per l'articolo selezionato nella pagina di modifica articolo & \\ \hline
RFO3.10.11 & L'utente autenticato deve poter annullare la modifica dell'articolo nella pagina di modifica articolo & \\ \hline
RFO3.10.12 & L'utente autenticato deve poter confermare la modifica dell'articolo nella pagina di modifica articolo & \\ \hline
RFO3.10.13 & Se l'utente autenticato conferma la modifica dell'articolo ed ha inserito una quantità errata (troppo bassa, troppo alta o che non soddisfa uno step impostato dall'azienda) deve essere visualizzato un messaggio d'errore di errata quantità inserita & \\ \hline
RFO3.10.14 & Se l'utente autenticato conferma la modifica dell'articolo e i dati modificati sono corretti, deve essere visualizzata la home page e l'articolo modificato deve essere presente in carrello con le modifiche apportate & \\ \hline
RFO3.10.15 & Se l'utente autenticato annulla la modifica dell'articolo, deve essere visualizzata la home page e l'articolo selezionato non deve essere stato modificato & \\ \hline
RFO3.10.16 & Se viene persa la connettività nella pagina di modifica, deve essere visualizzato un messaggio che invita l'utente a chiudere l'applicazione per connettività assente & \\ \hline
RFO3.11 & L'utente autenticato deve poter rimuovere gli articoli selezionati sul carrello premendo su un bottone presente sulla home page & \\ \hline
RFO3.11.1 & Se l'utente autenticato preme sul bottone di rimozione articoli senza aver selezionato alcun articolo, deve essere visualizzato un messaggio che inviti l'utente a selezionare degli articoli & \\ \hline
RFO3.11.2 & Se l'utente autenticato preme sul bottone di rimozione articoli avendo selezionato degli articoli sul carrello deve essere richiesta la conferma di eliminazione tramite un dialog & \\ \hline
RFO3.11.3 & Se l'utente autenticato conferma l'eliminazione sul dialog di conferma, gli articoli precedentemente selezionati devono essere rimossi dal carrello & \\ \hline
RFO3.11.4 & Se l'utente autenticato rifiuta l'eliminazione sul dialog di conferma, il carrello non deve subire cambiamenti & \\ \hline
RFO3.12 & L'utente autenticato deve poter inviare un ordine composto dagli articoli selezionati sul carrello premendo su un bottone di invio ordine & \\ \hline
RFO3.12.1 & Se l'utente autenticato preme sul bottone di invio ordine senza aver selezionato alcun articolo, deve essere visualizzato un messaggio che inviti l'utente a selezionare degli articoli & \\ \hline
RFO3.12.2 & Se l'utente autenticato preme sul bottone di invio ordine avendo selezionato degli articoli sul carrello deve essere visualizzato il modal di invio ordine & \\ \hline
RFO3.12.3 & L'utente autenticato deve poter visualizzare il codice cliente nel modal di invio ordine & \\ \hline
RFO3.12.4 & L'utente autenticato deve poter visualizzare la descrizione cliente nel modal di invio ordine & \\ \hline
RFO3.12.5 & L'utente autenticato deve poter visualizzare il codice del documento da generare per l'ordine nel modal di invio ordine & \\ \hline
RFO3.12.6 & L'utente autenticato deve poter visualizzare la descrizione del documento da generare per l'ordine nel modal di invio ordine & \\ \hline
RFO3.12.7 & Il modal di invio ordine deve proporre all'utente autenticato la data corrente come data d'ordine & \\ \hline
RFO3.12.8 & L'utente autenticato deve poter modificare la data d'ordine proposta nel modal di invio ordine & \\ \hline
RFO3.12.9 & L'utente autenticato deve poter inserire delle note per l'ordine nel modal di invio ordine & \\ \hline
RFO3.12.10 & L'utente autenticato deve poter confermare l'invio dell'ordine nel modal di invio ordine & \\ \hline
RFO3.12.11 & L'utente autenticato deve poter annullare l'invio dell'ordine nel modal di invio ordine & \\ \hline
RFO3.12.12 & Se l'utente autenticato decide di annullare l'invio dell'ordine, il modal di invio ordine deve essere chiuso & \\ \hline
RFO3.12.13 & Se l'utente autenticato decide di confermare l'invio dell'ordine, deve essere richiesta la conferma di invio ordine tramite un dialog & \\ \hline
RFO3.12.14 & Se l'utente autenticato conferma l'invio dell'ordine nel dialog di conferma e l'ordine è andato a buon fine, deve essere visualizzato un messaggio di ordine inviato con successo e una mail di conferma deve essere inviata sia all'utente che all'azienda & \\ \hline
RFO3.12.14.1 & La mail inviata dal sistema al momento dell'invio dell'ordine deve contenere in oggetto la data di registrazione dell'ordine & \\ \hline
RFO3.12.14.2 & La mail inviata dal sistema al momento dell'invio dell'ordine deve contenere in oggetto il codice azienda dell'utente che ha effettuato l'ordine & \\ \hline
RFO3.12.14.3 & La mail inviata dal sistema al momento dell'invio dell'ordine deve contenere in oggetto la tipologia di documento generato con l'ordine & \\ \hline
RFO3.12.14.4 & La mail inviata dal sistema al momento dell'invio dell'ordine deve contenere nel corpo il codice cliente del cliente che ha effettuato l'ordine & \\ \hline
RFO3.12.14.5 & La mail inviata dal sistema al momento dell'invio dell'ordine deve contenere nel corpo una tabella contenente i dati degli articoli inviati & \\ \hline
RFO3.12.14.6 & Per ogni articolo in tabella deve essere indicata la quantità ordinata & \\ \hline
RFO3.12.14.7 & Per ogni articolo in tabella deve essere indicato il codice articolo & \\ \hline
RFO3.12.14.8 & Per ogni articolo in tabella deve essere indicata la descrizione dell'articolo & \\ \hline
RFO3.12.14.9 & La mail inviata dal sistema al momento dell'invio dell'ordine deve contenere nel corpo l'avviso di non rispondere alla mail & \\ \hline
RFO3.12.15 & Se l'utente autenticato conferma l'invio dell'ordine nel dialog di conferma e l'ordine non è andato a buon fine, deve essere visualizzato un messaggio d'errore di mancato invio dell'ordine & \\ \hline
RFO3.12.16 & Se l'utente autenticato annulla l'invio dell'ordine nel dialog di conferma, il dialog di conferma deve essere chiuso & \\ \hline
RFO3.13 & Se viene persa la connettività nella home page, deve essere visualizzato un messaggio che invita l'utente a chiudere l'applicazione per connettività assente & \\
\hline
...
\textbf{Id Requisito} & \textbf{Descrizione} & \textbf{Fonti} \\ \hline
\endhead
RQO1 & L'applicazione deve essere fornita di manuale utente & -\\ \hline
RQD2 & L'applicazione deve essere fornita di manuale sviluppatore & -\\ \hline
\hline
