...
\begin{itemize}
	...
	\item \textbf{Scenario principale}: L'attore inserisce la \textit{username} tramite una \glossaryItem{text box}.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}: L'attore inserisce delle note per l'articolo tramite una \glossaryItem{text area}.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}: L'attore seleziona l'articolo in carrello tramite una \glossaryItem{checkbox}.
\end{itemize}
