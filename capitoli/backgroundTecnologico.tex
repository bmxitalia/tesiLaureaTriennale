...
\begin{figure}[!h] 
    ...
    \caption{Loghi di Lucidchart e TexMaker}
\end{figure}
...
\begin{figure}[!h] 
    ...
    \caption{Loghi di HTML5, CSS3 e JavaScript}
\end{figure}
