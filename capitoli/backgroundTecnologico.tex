...
\begin{figure}[!h] 
    \centering 
    \includegraphics[width=0.8\columnwidth]{tecnologie/git} 
...
\begin{figure}[!h] 
    \centering 
    \includegraphics[width=0.8\columnwidth]{tecnologie/asana} 
...
\begin{figure}[!h] 
    \centering 
    	...
    	\subfloat{\includegraphics[width=0.3\columnwidth]{tecnologie/astah}} 
    \caption{Logo di Gantt Project e Astah}
\end{figure}
...
\begin{figure}[!h] 
    \centering 
    \includegraphics[width=0.8\columnwidth]{tecnologie/tex} 
...
Ciò che ha favorito la scelta di CSS3 sono le media queries. Esse permettono di definire regole stilistiche in base alla tipologia del mezzo di visualizzazione, delle sue dimensioni nonchè della sua attuale disposizione (portrait o landscape). Ciò influisce non solo sull’aspetto esteriore degli elementi ma anche sul loro posizionamento e quindi sulla struttura stessa dell’interfaccia.

\begin{figure}[!h] 
    \centering 
    	\subfloat{\includegraphics[width=0.3\columnwidth]{tecnologie/html}}
    	\subfloat{\includegraphics[width=0.3\columnwidth]{tecnologie/css}} 
    \caption{Logo di HTML5 e CSS3}
\end{figure}

Per quanto riguarda il linguaggio JavaScript è stato utilizzato JavaScript puro senza l'utilizzo di framework o \glossaryItem{JQuery}.
