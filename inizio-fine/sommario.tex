...
Si è poi potuto proseguire con la progettazione delle varie componenti della piattaforma, quali \glossaryItem{servizio web}, \textit{database} sottostanti, logica applicativa e interfaccia grafica. 
L'applicazione doveva funzionare interamente online, nessun dato doveva essere memorizzato in locale, per cui il servizio web e i \textit{database} sono stati installati su un \glossaryItem{server Azure} di proprietà dell'azienda.
